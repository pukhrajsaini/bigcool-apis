...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["admin-admin-module"], {
  ...
  function srcAppAdminAdminModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AdminModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes), _shared_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"]], _shared_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"]]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AdminModule, {
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], _shared_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"]],
        exports: [_shared_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AdminModule, [{
        ...
        args: [{
          declarations: [_home_home_component__WEBPACK_IMPORTED_MODULE_2__["HomeComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes), _shared_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"]],
          exports: [_shared_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"]]
        }]
      }], null, null);
    })();
  ...
  function srcAppAdminHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_contact_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    function HomeComponent_div_5_mat_card_1_button_30_Template(rf, ctx) {
      if (rf & 1) {
        var _r20 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 13);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_5_mat_card_1_button_30_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r20);

          var query_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;

          var ctx_r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r18.onSolvedQuery(query_r14._id);
        });
    ...
    function HomeComponent_div_5_mat_card_1_span_31_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HomeComponent_div_5_mat_card_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_5_mat_card_1_Template_button_click_27_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r22);

          var query_r14 = ctx.$implicit;

          var ctx_r21 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r21.onDeleteQuery(query_r14._id);
        });
    ...
    function HomeComponent_mat_spinner_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    /*#__PURE__*/
    function () {
      function HomeComponent($router, $cs, $snackBar) {
      ...
      _createClass(HomeComponent, [{
        ...
        key: "fetchAllQueries",
        value: function fetchAllQueries() {
          var _this = this;

          this.isLoading = true;
          this.$cs.getAllQueries().subscribe(function (data) {
            _this.queries = data;
        ...
        key: "onDeleteQuery",
        value: function onDeleteQuery(_id) {
          var _this2 = this;

          this.$cs.deleteQuery(_id).subscribe(function (data) {
            if (!data) {
              _this2.fetchAllQueries();

              _this2.openSnackBar('query deleted', 'ok');
            }
          });
        }
      }, {
        key: "openSnackBar",
        value: function openSnackBar(data, action) {
        ...
        key: "onSolvedQuery",
        value: function onSolvedQuery(_id) {
          var _this3 = this;

          this.$cs.patchQuery(_id).subscribe(function (data) {
            if (data.status === 'success') {
              _this3.fetchAllQueries();

              _this3.openSnackBar('Query marked as Solved ', 'ok');
            }
          });
        }
      }]);
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 7,
      vars: 2,
      consts: [["color", "primary", 1, "navbar"], ["mat-button", "", 1, "bigcool"], ["mat-raised-button", "", "color", "warn", "mat-button", "", 1, "logout-btn", 3, "click"], ["class", "queries", 4, "ngIf"], ["color", "accent", 4, "ngIf"], [1, "queries"], [3, "ngClass", 4, "ngFor", "ngForOf"], [3, "ngClass"], [1, "row"], [1, "col-lg-4", "col-md-4", "col-sm-12"], ["mat-icon-button", "", "color", "warn", "title", "Delete Query", 1, "delete", 3, "click"], ["class", "mks", "mat-button", "", "color", "primary", 3, "click", 4, "ngIf"], ["class", "mks", 4, "ngIf"], ["mat-button", "", "color", "primary", 1, "mks", 3, "click"], [1, "mks"], ["color", "accent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
        ...
        return [{
          ...
          type: src_app_shared_contact_service__WEBPACK_IMPORTED_MODULE_2__["ContactService"]
        }, {
